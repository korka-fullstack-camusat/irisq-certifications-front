...
export default function CandidateLoginPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            setLoading(true);
            const { access_token, must_change_password } = await candidateLogin(email.trim(), password);
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden" style={{ border: "2px solid #e8eaf6" }}>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        <p className="text-sm text-gray-600">
                            Connectez-vous avec votre <strong>adresse email</strong> et votre <strong>mot de passe</strong>.
                        </p>
                    ...
                    <div className="px-6 pb-6 text-center space-y-2">
                        <p className="text-sm text-gray-500">
                            ...
                            <Link href="/candidat/register" className="font-bold text-green-700 hover:underline">
                                Créer un compte
                            </Link>
                        </p>
