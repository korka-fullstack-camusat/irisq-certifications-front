...
import { FilePenLine, FileCheck, LogOut, X } from "lucide-react";
...
export default function CorrecteurLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        { name: "Evaluations", href: "/correcteur",            icon: FilePenLine },
    ];
    ...
    return (
        <div className="flex min-h-screen font-sans" style={{ backgroundColor: "#f4f6f9" }}>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="px-6 py-6 text-center">
                                    ...
                                    <p className="font-bold text-gray-800 mb-1">Examinateur</p>
            ...
            >
                ...
                >
                    <Link href="/correcteur" className="flex flex-col items-center gap-2 group">
                ...
                <div className="flex-1 overflow-y-auto p-4">
                    ...
                    <nav className="space-y-1">
                        {navItems.map((item) => {
                            const isActive = item.href === "/correcteur"
                                ? pathname === item.href
                            ...
                            return (
                                ...
                                >
                                    {isActive && (
                                        <motion.span
                                            layoutId="sidebar-active-diamond-corr"
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-col min-w-0">
                            <span className="text-sm font-bold text-gray-800 truncate">Examinateur</span>
                            <span className="text-xs text-gray-400">Correction technique</span>
                        </div>
                        <LogOut
                            className="h-4 w-4 ml-auto opacity-0 group-hover:opacity-100 transition-opacity shrink-0"
                            style={{ color: "#c62828" }}
                        />
                    </button>
                </div>
            ...
            <main className="flex-1 flex flex-col min-w-0 md:pl-64">
                ...
                >
                    <Link href="/correcteur" className="flex items-center gap-2">
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            {isActive && (
                                <motion.div
                                    layoutId="mobile-nav-active-corr"
