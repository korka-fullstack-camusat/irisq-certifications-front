...
import { ClipboardList, File as FileIcon, LogOut, X, CheckCircle2 } from "lucide-react";
...
export default function EvaluatorLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        { name: "Candidatures", href: "/evaluateur", icon: ClipboardList },
        { name: "Examens par Certification", href: "/evaluateur/examens", icon: FileIcon },
        { name: "Resultats Candidats", href: "/evaluateur/corrections", icon: CheckCircle2 },
    ];
    ...
    return (
        <div className="flex min-h-screen font-sans" style={{ backgroundColor: "#f4f6f9" }}>
            ...
            >
                ...
                >
                    <Link href="/evaluateur" className="flex flex-col items-center gap-2 group">
                ...
                <div className="flex-1 overflow-y-auto p-4">
                    ...
                    <nav className="space-y-1">
                        {navItems.map((item) => {
                            const isActive = item.href === "/evaluateur"
                                ? pathname === item.href
            ...
            <main className="flex-1 flex flex-col min-w-0 md:pl-64">
                ...
                >
                    <Link href="/evaluateur" className="flex items-center gap-2">
